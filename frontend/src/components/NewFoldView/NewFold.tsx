...
const MODELS = ["monomer_ptm", "multimer", "boltz"];
...
function NewFold(props: {
    ...
    const handleSingleSubmit = () => {
        ...
        // If model is not in ["monomer_ptm", "multimer", "boltz"], throw an error.
        if (model && !["monomer_ptm", "multimer", "boltz"].includes(model)) {
            props.setErrorText("Invalid model.");
            return;
        }
        ...
        >
            <fieldset className="uk-fieldset">
                <form className="uk-form-horizontal uk-margin-left uk-margin-right">
                        ...
                        {MODELS.map((m) => (
                            <button
                                ...
                                className={
                                    ...
                                    (model === m ? "uk-button-primary" : "uk-button-default")
                                }
                                onClick={() => setModel(m)}
                            >{m}</button>
                        ))}
                    ...
                    {model === 'monomer_ptm' || isBatchEntry ? (
                        <textarea
                            className={
                    ...
                    {isBatchEntry ? null : (
                        ...
                        >
                            Canonicalize Sequence{model === 'monomer_ptm' ? "" : "s"}
                        </button>
                    )}
